    ...
    <Panel>
      <div className="w-full h-full flex flex-col items-center space-y-8">
        ...
        <p className="text-xs font-light text-center text-gray-500">
          ...
          account. If you have not recieve the email after a few minutes please
          check your span folder.
        </p>
        <div className="flex items-center justify-center space-x-14">
          <button className="text-xs font-semibold px-4 py-2 bg-indigo-500 hover:border-indigo-500 border hover:text-indigo-500 hover:bg-transparent text-white rounded-lg">
            Resend Email
          </button>
